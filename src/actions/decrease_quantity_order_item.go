...
func DecreaseQuantityOrderItem(orderItemId int64, body *model.BodyOrderItem) (*model.OrderItem, error) {
	queryString := ""
	var args []interface{}
	...
	if body.Quantity != nil {
		set = append(set, " quantity=IF(quantity - ? < 0, 0, quantity - ?)")
		args = append(args, body.Quantity, body.Quantity)
	}
